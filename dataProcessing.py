...
from integrationAPI import dataSite
...
class DataConverter:
    ...
    def treating_data(self):
        soup = BeautifulSoup(self._dataSite, 'html.parser')
...
dataConverter = DataConverter(dataSite=dataSite)
convertedData = dataConverter.treating_data()